...
class ActorEvents_6 extends ActorScript
{
	...
	override public function init()
	{
		...
		addWhenUpdatedListener(null, function(elapsedTime:Float, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				actor.push((Engine.engine.getGameAttribute("X of fish") - actor.getX()), (Engine.engine.getGameAttribute("Y of fish") - actor.getY()), 6);
			}
		});
		...
		addWhenUpdatedListener(null, function(elapsedTime:Float, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				Engine.engine.setGameAttribute("X of Bear", actor.getX());
				Engine.engine.setGameAttribute("Y of Bear", actor.getY());
			}
		});
